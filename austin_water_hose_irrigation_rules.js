/*
The following contains information about the City of Austin's water restriction stages as they apply to hose-end irrigation systems. 
...
exemptions within the water conservation code that are not addressed within the information below.
...
Conservation stage:
  ...
  Commercial/multifamily odd addresses can water on Friday
  Commercial/multifamily even addresses can water on Tuesday
  Residential odd addresses can water Wednesday and/or Saturday
  Residential even addresses can water Thursday and/or Sunday
  Public Schools can water Monday

Stage I:
  No watering between 10:00 AM and 7:00 PM
  Commercial/multifamily cannot water
  Residential odd addresses can water Wednesday and/or Saturday
  Residential even addresses can water Thursday and/or Sunday
  Public Schools can water Monday
...
Stage II:
  No watering between 10:00 AM and 7:00 PM
  Commercial/multifamily cannot water
  Residential odd addresses can water on Saturday
  Residential even addresses can water on Sunday
  Public Schools can water Monday

Stage III:
  No watering between 12:00 AM (Midnight) and 7:00 AM, 10:00 AM and 7:00 PM, and 10:00 PM and 11:59 PM.
  Commercial/multifamily cannot water
  Residential odd addresses can water on Saturday
  Residential even addresses can water on Sunday
  Public Schools can water Monday
...
This structure defines the City of Austin water restriction stages as they apply to hose-end irrigation systems.
  ...
  In the following example the entire JSON structure is assigned to a variable called HOSE_SCHEDULE. For the example, the current stage and a residential 
    property type will be selected.
    
    > HOSE_SCHEDULE.rules[HOSE_SCHEDULE.current] will select the current stage
    > HOSE_SCHEDULE.rules[HOSE_SCHEDULE.current][0] will select the residential property type in the current stage based on the HOSE_SCHEDULE.types array
    > HOSE_SCHEDULE.rules[HOSE_SCHEDULE.current][0][0] will select the rules for a range of addresses; this example assumes that range contains the 
      appropriate value; additional javascript functionality would be used to determine the appropriate array index
    > HOSE_SCHEDULE.rules[HOSE_SCHEDULE.current][0][0].address will return the applicable address array
    > HOSE_SCHEDULE.rules[HOSE_SCHEDULE.current][0][0].interval will return the numeric interval
    > HOSE_SCHEDULE.rules[HOSE_SCHEDULE.current][0][0].day will return the watering days array
    > HOSE_SCHEDULE.rules[HOSE_SCHEDULE.current][0][0].time will return the watering times array
*/
